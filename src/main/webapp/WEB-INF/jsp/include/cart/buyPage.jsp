            ...
            <div>
                ...
                <table class="addressTable">
                    <tr>
                        ...
                        <td><textarea name="address" value ="${user.address}"  placeholder="${user.address}"></textarea></td>
                    </tr>

                    <tr>
                        <td>收货人姓名<span class="redStar">*</span></td>
                        <td><input name="receiver" value ="${user.receiver}" placeholder="${user.receiver}" type="text"></td>
                    </tr>
                    <tr>
                        <td>手机号码 <span class="redStar">*</span></td>
                        <td><input name="mobile" value ="${user.mobile}" placeholder="${user.mobile}" type="text"></td>
                    </tr>
                </table>
